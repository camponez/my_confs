...
plugins=(bundler git git-extras git-flow gitignore git-prompt git-flow gitfast command-not-found ruby ssh-agent tmux F-Sy-H docker python cp docker docker-compose fzf-zsh jump)
